"""
Django settings for jessnatech project.
...
ALLOWED_HOSTS = ['jessnacinehub.pythonanywhere.com', 'www.jessnacinehub.pythonanywhere.com','127.0.0.1']
...
WSGI_APPLICATION = 'jessnatech.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'staticfiles')]  # Pour le développement
...
CINETPAY_COUNTRY = os.environ.get('CINETPAY_COUNTRY', 'CI')  # Pays: CI pour Côte d'Ivoire (par défaut CinetPay)
